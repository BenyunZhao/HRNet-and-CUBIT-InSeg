...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "Detect_SWF", "Segment_SWF", "Pose_SWF", "OBB_SWF"
...
class Segment_SWF(Detect_SWF):
    ...
    def __init__(self, nc=80, nm=32, npr=256, hidc=256, ch=()):
        ...
        self.npr = npr  # number of protos
        self.proto = Proto(ch[0], self.npr, self.nm)  # protos
        self.detect = Detect_SWF.forward
